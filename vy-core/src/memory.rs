...
impl Memory {
    /// Create a new memory system with the given storage file
...
["Has a son named Henry who is turning 18", "Has appointment with nutritionist Michael at 4pm", "Needs to update food logging in Cronometer"]"#
    ...
    /// Learn new facts from input text using LLM analysis
    ...
    /// Get the total number of facts stored
...
mod tests {
    ...
    async fn test_save_load() {
        ...
        {
            let mut memory = Memory::new(file_path.clone());
